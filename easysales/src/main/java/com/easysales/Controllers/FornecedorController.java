...
public class FornecedorController{
    ...
    public ResponseEntity<Fornecedor> GetFornecedorById(@PathVariable(value = "id") String id){
...
//    }
    ...
    public ResponseEntity<Fornecedor> PutFornecedor(@PathVariable(value = "id") String id, @Validated @RequestBody Fornecedor newFornecedor)
    {
    ...
    public ResponseEntity<Fornecedor> DeleteFornecedor(@PathVariable(value = "id") String id){
        Optional<Fornecedor> fornecedor = fornecedorRepository.findById((id));
        if (fornecedor.isPresent()){
