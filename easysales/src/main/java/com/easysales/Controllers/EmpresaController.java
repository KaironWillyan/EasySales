...
public class EmpresaController{
    ...
    public ResponseEntity<Empresa> GetEmpresaById(@PathVariable(value = "id") String id){
    ...
    public ResponseEntity<Empresa> PutEmpresa(@PathVariable(value = "id") String id, @Validated @RequestBody Empresa newEmpresa)
    {
    ...
    public ResponseEntity<Empresa> DeleteEmpresa(@PathVariable(value = "id") String id){
        Optional<Empresa> empresa = empresaRepository.findById((id));
        if (empresa.isPresent()){
