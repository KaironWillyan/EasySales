...
//    }
    ...
    public ResponseEntity<Cliente> PutCliente(@PathVariable(value = "id") String id, @Validated @RequestBody Cliente newCliente)
    {
    ...
    public ResponseEntity<Cliente> DeleteCliente(@PathVariable(value = "id") String id){
        Optional<Cliente> cliente = clienteRepository.findById((id));
        if (cliente.isPresent()){
