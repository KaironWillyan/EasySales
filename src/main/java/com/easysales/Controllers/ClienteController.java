    ...
    public class ClienteController {
        ...
        public ResponseEntity<Cliente> GetClienteById(@PathVariable(value = "idCli") Long id) {
    ...
    //    }
        ...
        public ResponseEntity<Cliente> PutCliente(@PathVariable Long id, @Validated @RequestBody Cliente newCliente) {
